package ajiet.cse.madlab.program4;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void parsexml(View V){
        try {
            ...
            e.printStackTrace();
            Toast.makeText(MainActivity.this,"Error In Reading The XML", Toast.LENGTH_LONG).show();
        }
    }
    public void parsejson(View V){
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(MainActivity.this,"Error In Reading The JSON File", Toast.LENGTH_LONG).show();
        }
    }
